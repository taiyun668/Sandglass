(function () {
  ...
  Object.assign(messages["es-ES"], {
    ...
    sourceTotalsReady: "Hay {count} minuto(s) sin colisión ({tokens} Token) listos para tu elección.", sourceTotalsApplied: "Se incluyen {count} minuto(s) ({tokens} Token) con su origen; desactívalo para revertir.", userSourceWindowLocked: "Incluye evidencia de adaptador no autorizada para la ventana completa.", updateTitle: "La versión {version} está disponible", updateCopy: "La actualización ya está descargada y verificada. Confirma para instalarla y reiniciar Sandglass.", updateApply: "Actualizar ahora", updateApplying: "Actualizando…", updateFailed: "La actualización no se ejecutó. No se cambió nada.", staleQuotaExplanation: "La lectura de cuota ha caducado, por lo que no se estima la ventana completa.", rolledWindowExplanation: "El periodo oficial caducó, así que esta ventana se redefinió con registros locales y no se estima la ventana completa.", sourceWindowReady: "Puedes autorizar esta fuente por separado; su nombre permanecerá junto a la estimación.", sourceWindowApplied: "La ventana completa está autorizada y muestra estas fuentes: {sources}."
  });
  Object.assign(messages["fr-FR"], {
    ...
    sourceTotalsReady: "{count} minute(s) sans collision ({tokens} Token) attendent votre choix.", sourceTotalsApplied: "{count} minute(s) ({tokens} Token) sont incluses et étiquetées ; désactivez pour annuler.", userSourceWindowLocked: "Ces données incluent un adaptateur non autorisé pour la fenêtre complète.", updateTitle: "La version {version} est disponible", updateCopy: "La mise à jour est déjà téléchargée et vérifiée. Confirmez pour l’installer et redémarrer Sandglass.", updateApply: "Mettre à jour", updateApplying: "Mise à jour…", updateFailed: "La mise à jour n’a pas été lancée. Rien n’a été modifié.", staleQuotaExplanation: "La lecture du quota a expiré ; aucune estimation de fenêtre complète n’est affichée.", rolledWindowExplanation: "La période officielle a expiré ; cette fenêtre a été redéfinie à partir des enregistrements locaux, sans estimation de fenêtre complète.", sourceWindowReady: "Vous pouvez autoriser cette source séparément ; son nom restera près de l’estimation.", sourceWindowApplied: "La fenêtre complète est autorisée et affiche ces sources : {sources}."
  });
  Object.assign(messages["de-DE"], {
  ...
  Object.assign(messages["ja-JP"], {
    ...
    sourceTotalsReady: "衝突のない {count} 分（{tokens} Token）を追加できます。", sourceTotalsApplied: "{count} 分（{tokens} Token）を出典付きで追加中です。オフにすると元に戻ります。", userSourceWindowLocked: "全期間推定を許可していないアダプター証拠を含みます。", updateTitle: "バージョン {version} が利用できます", updateCopy: "アップデートはダウンロードと検証が完了しています。確認するとインストールして Sandglass を再起動します。", updateApply: "今すぐ更新", updateApplying: "更新中…", updateFailed: "更新は実行されませんでした。変更はありません。", staleQuotaExplanation: "残量の読み取りが古いため、全期間推定は表示しません。", rolledWindowExplanation: "公式の期間が終了しているため、この期間はローカル記録から引き直しました。全期間推定は行いません。", sourceWindowReady: "このソースを別途許可できます。推定値の横に名前を表示し続けます。", sourceWindowApplied: "全期間推定を許可済み。表示するソース：{sources}。"
  });
  Object.assign(messages["ko-KR"], {
